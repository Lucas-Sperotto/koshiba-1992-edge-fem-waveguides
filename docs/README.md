...
Este diretório reúne a tradução técnica do artigo, notas editoriais, complementos matemáticos e o contrato que libera o início da implementação C++17.
...
A fase documental está fechada como baseline científica e didática. A implementação já chegou ao solver beta mínimo, à política essencial inicial de PEC/PMC e à primeira auditoria algébrica de sinais; a validação quantitativa das Figuras 3, 5 e 7 segue pendente.
